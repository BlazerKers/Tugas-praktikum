    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="<?php echo e(Vite::asset('resources/sass/images/logo-white.svg')); ?>" alt="logo" style="width: 40px;">
            </a>
            <!-- Navbar Toggler -->
...
bg-purple" type="button"><small>Latest
...
text-white"></div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="<?php echo e(Vite::asset('resources/sass/images/main.svg')); ?>" alt="main
    logo">
                </div>
            ...
            btn-lg mb-3 me-md-3 px-4 py-3">Get
                                Started</button>
                            <button type="button"
    ...
    text-white"></i>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo e(Vite::asset('resources/sass/images/bs-icons.png')); ?>" alt="Bootstrap Icons">
                </div>
            </div>
        </div>
    </div>
    ...
    text-white"></i>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo e(Vite::asset('resources/sass/images/bs-themes.png')); ?>" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="<?php echo e(Vite::asset('resources/sass/images/logo-black.svg')); ?>" alt="Bootstrap Logo"
                                style="width: 40px;">
...
<?php /**PATH C:\Users\zulfa\zulfa\resources\views/index.blade.php ENDPATH**/ ?>